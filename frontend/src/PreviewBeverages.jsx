...
function PreviewBeverages() {
  const navigate = useNavigate()
  const [products, setProducts] = useState([])
  const [loading, setLoading] = useState(true)

  useEffect(() => {
    document.title = "Selectra - Beverages Preview"
    fetch(`${API}/beverages`)
      .then(r => r.json())
      .then(data => {
        setProducts(data)
    ...
    <div className="home-page">
      ...
      <div className="page">
        ...
        <header className="header">
          <p>Browse all beverage products available in Selectra.</p>
        </header>
...
export default PreviewBeverages